package com.TT.SincereAgree.amei.photopicker;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    class ViewHolde {
        ...
        ViewHolde(View view){
            image = (ImageView) view.findViewById(R.id.select_ima_item_image);
            indicator = (ImageView) view.findViewById(R.id.select_ima_item_checkmark);
            mask = view.findViewById(R.id.select_ima_item_mask);
            view.setTag(this);
        }
