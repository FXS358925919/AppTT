...
public class RongRedPacketMessage extends MessageContent {
    ...
    public static RongRedPacketMessage obtain(String fromid, String userid, String message, String account, boolean sincerity) {
        RongRedPacketMessage rongRedPacketMessage = new RongRedPacketMessage();
        rongRedPacketMessage.fromid = fromid;
        rongRedPacketMessage.userid = userid;
        rongRedPacketMessage.message = message;
        rongRedPacketMessage.account = account;
        rongRedPacketMessage.sincerity = sincerity;
